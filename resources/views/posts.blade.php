  ...
  <div class="card mb-3">
    @if ($posts[0]->image)
      <div style="max-height: 350px; overflow:hidden">
        ...
        @else
        <img src="https://matematika.uinsu.ac.id/wp-content/uploads/2021/02/book.jpeg" class="card-img-top" alt="https://api.unsplash.com/1200x400/?{{ $posts[0]->category->name }}">
    @endif
